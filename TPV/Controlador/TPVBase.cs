...
namespace TPV.Controlador
{
    ...
    public class TPVBase
    {
        ...
        private void CargarUsuariosPredeterminados()
        {
            ...
            {
                ControladorComun.BD!.PersistirObjeto(new Usuario(0, "7777", 0, true, "Encargado", new Uri("pack://application:,,,/Recursos/Imagenes/encargado.png", UriKind.Absolute), "TemaOriginal"));
                ControladorComun.BD!.PersistirObjeto(new Usuario(1, "1111", 0, false, "Vendedor", new Uri("pack://application:,,,/Recursos/Imagenes/vendedor.png", UriKind.Absolute), "TemaAC"));
            }
        ...
        private void CargarProductos()
        {
            ...
            { //Productos de muestra incluidos el proyecto para la presentación
                //Sushi
                ControladorComun.BD!.PersistirObjeto(new Producto(0, 0, "California Maki", "California Maki 4 unidades", this._tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/californiamaki.png", UriKind.Absolute)));                
                ControladorComun.BD!.PersistirObjeto(new Producto(1, "Futo Maki", "Futo Maki 4 unidades", this._tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/futomaki.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(2, "Band. 10 Hosomaki", "Bandeja de 10 Hosomaki", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/5hsomaki.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(3, "Gunkan Maki", "Gunkan Maki 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/gunkanmaki.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(4, "Hoso Maki", "Hoso Maki 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/hosomaki.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(5, "Iniozuki", "Iniozuki 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/iniozuki.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(6, "Maguro Nigiri", "Maguro Nigiri 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/maguronigiri.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(7, "Nigiri", "Nigiri 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/nigiri.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(8, "TriFutoMaki", "Futo Maki Triangular 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/triFutomaki.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(9, "Uramaki", "Uramaki 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/uramaki.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(10, "Philadelphia Roll", "Philadelphia Roll 4 unidades", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/philadelphiaroll.png", UriKind.Absolute)));
                //Bebidas
                ControladorComun.BD!.PersistirObjeto(new Producto(11, "Sake", "15ml de Sake", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/sake.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(12, "Cerveza Sapporo", "Cerveza Sapporo 33cl", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/sapporo.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(13, "Copa de vino rosado", "Copa de vino rosado de la casa", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/copavino.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(14, "Agua Evian", "Botella de 25cl", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/evian.png", UriKind.Absolute)));
                //Complementos
                ControladorComun.BD!.PersistirObjeto(new Producto(15, "Palillos", "Palillos chinos", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/palillos.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(16, "Gengibre", "Gengibre 1 ración", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/ginger.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(17, "Wasabi", "Wasabi 1 ración", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/wasabi.png", UriKind.Absolute)));
                ControladorComun.BD!.PersistirObjeto(new Producto(18, "Soja", "Salsa de soja 1 ración", _tpvCFG.CodTienda, new Uri("pack://application:,,,/Recursos/Imagenes/Productos/soja.png", UriKind.Absolute)));
            }   
